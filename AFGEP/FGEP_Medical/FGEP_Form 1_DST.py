...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        policyTerm.click()
        time.sleep(1)
        optionInPolicyTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_21']")
        ...
        premiumCommitFill.send_keys("500000")
        ...
        riderTerm.click()
        time.sleep(1)
        optionInRiderTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_18']")
        ...
        childyearNomineeSel.select_by_value('2007')
        ...
        accountTypeSelect = self.driver.find_element(By.XPATH, "//*[contains(text(), 'NRO')]")
