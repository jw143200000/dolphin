...
class mProAutomate:
    ...
    def newApplicationFormOneStepOne(self):
        ...
        # enterCustomerId.send_keys("2460")
        enterCustomerId.send_keys("197")
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        premiumCommitFill.send_keys("450000")
    ...
    def newApplicationFormOneStepThree(self):
        ...
        yearNomineeSel.select_by_value('1992')
        ...
        childyearNomineeSel.select_by_value('2016')
