...
class mProAutomate:
    ...
    # SPARC- 782058 | MNYL@2020, rpdel6793, ABBBY6754  | max@1234
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        stateFill.send_keys('KARN')
        time.sleep(1)
        stateToSel=self.driver.find_element(By.XPATH, "//*[contains(text(),'KARN')]")
        stateToSel.click()
        time.sleep(1)
        print("State Filled")
        ...
        cityFill.click()
        cityFill.send_keys('KOLA')
        time.sleep(1)
        cityToSel= self.driver.find_element(By.XPATH, "//*[contains(text(),'KOLA')]")
        cityToSel.click()
        time.sleep(1)
        print("City Filled")

        pinToFill= self.driver.find_element(By.XPATH, "//*[@name='permanentPinCode']")
        pinToFill.send_keys('122018')
        time.sleep(1)
        ...
        time.sleep(1)
        optionInPremiumPaymentTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_13']")
        ...
        policyTerm.click()
        time.sleep(1)
        optionInPolicyTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_16']")
        ...
        premiumCommitFill.send_keys("70000")
