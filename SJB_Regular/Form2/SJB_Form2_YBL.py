...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        optionInInsuranceDropdown = self.driver.find_element(By.XPATH, "(//*[contains(text(),'Children’s marriage/education')])[1]")
        ...
        grossIncomeFill.send_keys('1500000')
        ...
        premiumType.click()
        time.sleep(1)
        optionInpremiumType = self.driver.find_element(By.XPATH, "//*[@id='liId_Regular Pay']")
        ...
        optionInpremiumPaymentType = self.driver.find_element(By.XPATH, "//*[@id='liId_15']")
    ...
    def newApplicationFormOneStepThree(self):
        ...
        industry.click()
        time.sleep(2)
        optionindustry = self.driver.find_element(By.XPATH, "//*[@id ='liId_Diving']")
        ...
        org.click()
        time.sleep(2)
        optionorg = self.driver.find_element(By.XPATH, "//*[@id ='liId_Private Voluntary Organization (PVO)']")
        optionorg.click()
        time.sleep(2)

        naitionality= self.driver.find_element(By.XPATH, "(//*[contains(text(),'No')])[3]")
        naitionality.click()

        annualIncome= self.driver.find_element(By.XPATH, "//*[@name='insurerAnnualIncome']")
        annualIncome.send_keys("50000")
        time.sleep(1)
