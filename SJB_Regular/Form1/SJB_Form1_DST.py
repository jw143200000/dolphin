...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        firstNameFill.send_keys("Virendra Singh")
        ...
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@id='liId_Aadhaar']")))
        ...
        optionInInsuranceDropdown=self.driver.find_element(By.XPATH,"//*[@id='liId_Protection']")
        ...
        ppt.click()
        time.sleep(1)
        optionInppt = self.driver.find_element(By.XPATH, "//*[@id='liId_15']")
        optionInppt.click()
        ...
        fatherNameFill.send_keys("Kishore")

        motherNameFill = self.driver.find_element(By.XPATH, "//*[@name='motherName']")
        motherNameFill.send_keys("Chanchal")
        ...
        time.sleep(1)
        optionInEducationDropdown= self.driver.find_element(By.XPATH, "//*[contains(text(), 'Senior School')]")
        ...
        nomineeFill.send_keys("Kritika Singh Chanchal")
        ...
        yearNomineeSel.select_by_value('1982')
        ...
        dateNomineeSel = self.driver.find_element(By.XPATH, "//*[@aria-label='day-1']")
