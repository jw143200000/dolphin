...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        optionInInsuranceDropdown = self.driver.find_element(By.XPATH,"//*[@id='liId_Regular income']")
        ...
        productName = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[8]")
        productName.click()
        time.sleep(1)
        ...
        print("Limited Selected")
        time.sleep(2)

        premiumTerm = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[10]")
        premiumTerm.click()
        time.sleep(1)
        optionInpremiumTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_35']")
        optionInpremiumTerm.click()
        print("PPT Selected")
        time.sleep(1)
    ...
    def newApplicationFormOneStepThree(self):
        ...
        fatherNameFill.send_keys("Ranjeet")
        ...
        time.sleep(1)
        optionInEducationDropdown = self.driver.find_element(By.XPATH, "//*[contains(text(), 'Diploma')]")
        ...
        time.sleep(1)
        optionInIndustrySelect = self.driver.find_element(By.XPATH, "//*[contains(text(),'Mining')]")
        ...
        time.sleep(1)
        optionInPreferredLanguage = self.driver.find_element(By.XPATH, "//*[@id='liId_Oriya']")
        ...
        nomineeFill.send_keys("Anmold Singh")


        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@value='Anmold Singh']")))
        ...
        # self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@for='accountNumberforBank01']")))
        # bankSelect = self.driver.find_element(By.XPATH, "//*[@for='accountNumberforBank01']")
        # bankSelect.click()
        # print("Bank Details Selected.")
        # time.sleep(1)
    ...
    def newApplicationFormOneStepFour(self):
        ...
        heightInFeet.click()
        time.sleep(1)
        selectHeightInFeet = self.driver.find_element(By.XPATH, "//*[@id='liId_4']")
