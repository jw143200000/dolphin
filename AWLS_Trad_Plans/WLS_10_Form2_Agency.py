...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        firstNameFill.send_keys("Anil Kumar")

        lastNameFill = self.driver.find_element(By.XPATH,"//*[@name='lastName']")
        lastNameFill.send_keys("Jha")
        ...
        stateFill.send_keys('BIHA')
        time.sleep(1)
        stateToSel=self.driver.find_element(By.XPATH, "//*[contains(text(),'BIH')]")
        stateToSel.click()
        time.sleep(1)
        print("State Filled")
        ...
        cityFill.click()
        cityFill.send_keys('DARBHA')
        time.sleep(1)
        cityToSel= self.driver.find_element(By.XPATH, "//*[contains(text(),'DAR')]")
        cityToSel.click()
        time.sleep(1)
        print("City Filled")
        ...
        alternateNumberToFill.send_keys('7042970922')
        ...
        lifeToInsured = self.driver.find_element(By.XPATH,
                                                 "//*[@name= 'insurerName']")
        lifeToInsured.send_keys("Sunil Kumar Jha")
        time.sleep(1)
        ...
        relationshipFilled = self.driver.find_element(By.XPATH, "//*[@name ='relationshipWithProposerWhenOther']")
        relationshipFilled.send_keys("Brother")
        time.sleep(1)
        ...
        optionInOccupation = self.driver.find_element(By.XPATH, "//*[@id='liId_Self Employed From Home']")
        ...
        policyTerm.click()
        time.sleep(1)
        optionInPolicyTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_58']")
        ...
        mode.click()
        time.sleep(1)
        optionInmode = self.driver.find_element(By.XPATH, "//*[@id='liId_Monthly']")
        optionInmode.click()
        print("Policy Term Selected")
        time.sleep(1)

        popupclose= self.driver.find_element(By.XPATH, "//*[@d='M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z']")
        popupclose.click()
        time.sleep(1)
        ...
        enterADDrider.send_keys("200000")
        time.sleep(1)
        ...
        time.sleep(1)
        optionInEducationDropdown= self.driver.find_element(By.XPATH, "//*[contains(text(), 'Primary School')][1]")
        ...
        accountTypeSelect = self.driver.find_element(By.XPATH, "//*[contains(text(), 'Current')]")
        ...
        optioneducationdropdownn = self.driver.find_element(By.XPATH, "//*[@id='liId_Primary School']")
        ...
        optionindsturyDropdown= self.driver.find_element(By.XPATH, "//*[@id='liId_Mining']")
