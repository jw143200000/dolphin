...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        grossIncomeFill.send_keys('10000000')
        ...
        dividentAdjustment = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[10]")
        ...
        modeOfPayment.click()
        time.sleep(1)
        optinoInmodeOfPayment = self.driver.find_element(By.XPATH, "//*[@id='liId_Semi-Annual']")
        ...
        enterTermrider.send_keys("160000")
        time.sleep(1)
        riderSelected = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[13]")
        riderSelected.click()
    ...
    def newApplicationFormOneStepThree(self):
        ...
        fatherNameFill.send_keys("Ganit")
        ...
        time.sleep(1)
        optionInIndustrySelect = self.driver.find_element(By.XPATH, "//*[contains(text(), 'Mining')][1]")
        ...
        yearNomineeSel.select_by_value('1998')
    ...
    def newApplicationFormOneStepFour(self):
        ...
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "(//*[contains(text(), 'No')])[5]")))
        time.sleep(1)

        criticalIllnessSelect = self.driver.find_element(By.XPATH, "(//*[contains(text(), 'No')])[5]")
        criticalIllnessSelect.click()
