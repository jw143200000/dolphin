...
class mProAutomate:
    ...
    def selectPlan(self):
        ...
        categorySelect= self.driver.find_element(By.XPATH, "//*[contains(text(),'MARRIED WITH YOUNG KIDS')]")
        categorySelect.click()
        print("Plan Selected")

        planSelect = self.driver.find_element(By.XPATH, "//*[contains(text(),'CHILD EDUCATION')]")
        planSelect.click()
        time.sleep(1)
        ...
        optionInPlan= self.driver.find_element(By.XPATH, "//*[contains(text(),'Max Life Future Genius Education Plan')]")
        optionInPlan.click()
        time.sleep(3)
    ...
    def illustration(self):
        ...
        time.sleep(1)
        optionInpremiumPaymentTerm = self.driver.find_element(By.XPATH, "//*[@id='ppt']/option[1]")
        ...
        PolicyTerm.click()
        time.sleep(1)
        optionInPolicyTerm = self.driver.find_element(By.XPATH, "//*[@id='policyTerm']/option[9]")
        ...
        premiumCommitment.clear()
        premiumCommitment.send_keys("90000")
        time.sleep(1)
        print("Premium Filled")

        maturity = self.driver.find_element(By.ID, "maturityAmount")
        maturity.clear()
        maturity.send_keys("300000")
        time.sleep(1)
        print("Maturity Filled")
