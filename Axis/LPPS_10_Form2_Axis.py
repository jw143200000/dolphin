...
class mProAutomate:
    ...
    def loginFunctionality(self):
        ...
        crmID.clear()
        crmID.send_keys("1000058454")

        custID= self.driver.find_element(By.ID, "customer_id")
        custID.clear()
        custID.send_keys("956272302")
        ...
        monthSel.select_by_value('4')
        time.sleep(1)

        dateSel = self.driver.find_element(By.XPATH, "//*[@class='react-datepicker__day react-datepicker__day--014']")
        dateSel.click()
        time.sleep(1)
    ...
    def selectPlan(self):
        ...
        optionInPlan= self.driver.find_element(By.XPATH, "//*[contains(text(),'Max Life Life Perfect Partner Super')]")
        optionInPlan.click()
        time.sleep(3)
