...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        orgDropdown.click()
        time.sleep(1)
        optionorgDropdown = self.driver.find_element(By.XPATH, "//*[@id ='liId_Non-Profit organization (NPO)']")
        ...
        orgDropdown.click()
        time.sleep(1)
        optionorgDropdown = self.driver.find_element(By.XPATH, "//*[@id ='liId_Professional']")
        optionorgDropdown.click()
        time.sleep(1)

        annualIncome = self.driver.find_element(By.XPATH, "//*[@name='insurerAnnualIncome']")
        annualIncome.click()
        annualIncome.send_keys("700000")
        time.sleep(1)
