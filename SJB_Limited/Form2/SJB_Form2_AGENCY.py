...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        optionInLifeStage= self.driver.find_element(By.XPATH, "//*[contains(text(), 'Close to retirement or retired')]")
