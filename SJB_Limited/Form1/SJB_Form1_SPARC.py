...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        firstNameFill.send_keys("UJJAWALA")

        lastNameFill = self.driver.find_element(By.XPATH,"//*[@name='lastName']")
        lastNameFill.send_keys("MALIKA")
        ...
        time.sleep(1)
        stateToSel=self.driver.find_element(By.XPATH, "//*[contains(text(),'ASSAM')]")
        stateToSel.click()
        time.sleep(1)
        print("State Filled")
        time.sleep(1)
        ...
        cityFill.click()
        cityFill.send_keys('GUW')
        time.sleep(1)
        cityToSel= self.driver.find_element(By.XPATH, "//*[contains(text(),'Guw')]")
        cityToSel.click()
        time.sleep(1)
        print("City Filled")
        time.sleep(1)
        ...
        optionInLifeStage= self.driver.find_element(By.XPATH, "//*[@id='liId_Single with Children']")
        ...
        ppt.click()
        time.sleep(1)
        optionInppt = self.driver.find_element(By.XPATH, "//*[@id='liId_10']")
        optionInppt.click()
        ...
        policyTerm.click()
        time.sleep(1)
        optionInpolicyTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_26']")
        ...
        time.sleep(1)
        optionInOrganisationSelect = self.driver.find_element(By.XPATH, "//*[@id='liId_Non-Profit organization (NPO)']")
        ...
        dateNomineeSel = self.driver.find_element(By.XPATH, "//*[@aria-label='day-31']")
