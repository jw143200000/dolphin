...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        time.sleep(1)
        optionInEducationDropdown= self.driver.find_element(By.XPATH, "//*[contains(text(), 'Post Graduate')]")
        ...
        dateNomineeSel = self.driver.find_element(By.XPATH, "//*[@aria-label='day-8']")
