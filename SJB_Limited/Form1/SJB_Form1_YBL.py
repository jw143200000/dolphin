...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        time.sleep(1)
        optionInPremiumPaymentTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_Limited Pay']")
        ...
        premiumTerm.click()
        time.sleep(1)
        optionInpremiumTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_5']")
        ...
        policyTerm.click()
        time.sleep(1)
        optionInpolicyTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_14']")
        ...
        modeOfPayment.click()
        time.sleep(1)
        optionInmodeOfPayment = self.driver.find_element(By.XPATH, "//*[@id='liId_Semi-Annual']")
    ...
    def newApplicationFormOneStepThree(self):
        ...
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@value='DEV SINGH BORA']")))
        ...
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@value='YES-YES BANK LTD.']")))
