...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        optionInPolicyTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_45']")
        optionInPolicyTerm.click()
        print("Policy Term Selected")
        time.sleep(2)

        mode = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[12]")
        mode.click()
        time.sleep(1)
    ...
    ###################Life To Insured #####################
        ...
        annualIncome.send_keys("400000")
        time.sleep(1)

        occupation = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[16]")
        occupation.click()
        time.sleep(2)
        optionoccupation = self.driver.find_element(By.XPATH, "//*[@id ='liId_Salaried']")
