...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        # dateSel = self.driver.find_element(By.XPATH, "//*[@aria-label='day-22']")
        dateSel = self.driver.find_element(By.XPATH, "//*[@aria-label='day-18']")
        dateSel.click()
        time.sleep(2)
        ...
        optionInPolicyTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_24']")
        ...
        enterADDrider.send_keys("500000")
