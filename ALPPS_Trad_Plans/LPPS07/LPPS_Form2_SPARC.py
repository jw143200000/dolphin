...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        modeSelected = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[13]")
        modeSelected.click()
        print("Dividend dropdown Clicked")
        time.sleep(2)

        optionInmodeSelected = self.driver.find_element(By.XPATH, "//*[@id='liId_Annual']")
        optionInmodeSelected.click()
        ...
        time.sleep(1)
        orgName = self.driver.find_element(By.XPATH, "//*[@name='insurerCompanyName']")
