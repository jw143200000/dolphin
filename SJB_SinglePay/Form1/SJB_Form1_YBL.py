...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        premiumTerm.click()
        time.sleep(1)
        optionInpremiumTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_1']")
    ...
    def newApplicationFormOneStepThree(self):
        ...
        time.sleep(1)
        optionInEducationDropdown = self.driver.find_element(By.XPATH, "//*[contains(text(), 'Graduate')]")
        ...
        yearNomineeSel.select_by_value('1988')
        ...
        dateNomineeSel = self.driver.find_element(By.XPATH, "//*[@aria-label='day-26']")
        ...
        self.wait.until(EC.visibility_of_element_located((By.XPATH, "//*[@value='YES-YES BANK LTD.']")))
