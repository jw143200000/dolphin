...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        optioneducationdropdownn = self.driver.find_element(By.XPATH, "//*[@id='liId_High School']")
        ...
        optionorgDropdown = self.driver.find_element(By.XPATH, "//*[@id='liId_Not Applicable']")
