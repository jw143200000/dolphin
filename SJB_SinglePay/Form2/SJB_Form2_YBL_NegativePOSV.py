...
class mProAutomate:
    ...
    def newApplicationFormOneStepOne(self):
        ...
        enterCustomerId.send_keys("26262626")
        time.sleep(1)
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        dateSel = self.driver.find_element(By.XPATH, "//*[@aria-label='day-6']")
        dateSel.click()
        time.sleep(2)
        ...
        premiumType.click()
        time.sleep(1)
        optionInpremiumType = self.driver.find_element(By.XPATH, "//*[@id='liId_Single Pay']")
        ...
        optionInpremiumPaymentType = self.driver.find_element(By.XPATH, "//*[@id='liId_1']")
    ...
    def newApplicationFormOneStepThree(self):
        ...
        fatherNameFill.send_keys("Sumt Father")
        ...
        natureSelect.click()
        time.sleep(1)
        optionInNatureSelect = self.driver.find_element(By.XPATH, "//*[@id='liId_Non-combat role']")
        ...
        industry.click()
        time.sleep(1)
        optionindustry = self.driver.find_element(By.XPATH, "//*[@id ='liId_Others']")
        ...
        org.click()
        time.sleep(1)
        optionorg = self.driver.find_element(By.XPATH, "//*[@id ='liId_Pvt Ltd']")
        optionorg.click()
        time.sleep(1)
        ...
        nature.click()
        time.sleep(1)
        optionnature = self.driver.find_element(By.XPATH, "//*[@id ='liId_Salaried']")
        optionnature.click()
        time.sleep(1)
        ...
        time.sleep(1)
        nameOrg = self.driver.find_element(By.XPATH, "//*[@name='insurerCompanyName']")
        nameOrg.send_keys("MAXIMUM")
        time.sleep(1)
