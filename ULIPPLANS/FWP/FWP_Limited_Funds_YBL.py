...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        variantDropdown = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[8]")
        ...
        coverMultipeDropdown = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[10]")
        ...
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@id='liId_30%']")))
