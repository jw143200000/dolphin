...
class mProAutomate:
    ...
    # YBL  - 718842 | mnyl@4321 | Customer ID-  29471, 47942, 616658 (222222), 2753439, 866238,
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        print("Window On Step 2=",windowBefore)
        ...
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "(//*[contains(text(), 'Driving license')])[1]")))
        proofSel=self.driver.find_element(By.XPATH, "(//*[contains(text(), 'Driving license')])[1]")
        proofSel.click()
        time.sleep(1)
        ...
        grossIncomeFill.send_keys('200000')
        ...
        premiumTypeOption = self.driver.find_element(By.XPATH, "//*[@id='liId_Limited Pay']")
        ...
        modeOfPayment.click()
        time.sleep(1)
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@id='liId_Annual']")))
        ...
        dynamicFund = self.driver.find_element(By.XPATH, "//*[@for='dynamicFundNo']")
        dynamicFund.click()

        systematicFund = self.driver.find_element(By.XPATH, "//*[@for='systematicNo']")
        systematicFund.click()

        systematicFund = self.driver.find_element(By.XPATH, "//*[@for='systematicNo']")
        systematicFund.click()

        triggerFund = self.driver.find_element(By.XPATH, "//*[@for='triggerYes']")
        triggerFund.click()
        print("Trigger Selected")


        triggerFundOne = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[15]")
        triggerFundOne.click()
        time.sleep(1)
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@id='liId_Growth Super Fund']")))
        optionIntriggerFundOne = self.driver.find_element(By.XPATH, "//*[@id='liId_Growth Super Fund']")
        optionIntriggerFundOne.click()
        time.sleep(1)

        triggerFundTwo = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[16]")
        triggerFundTwo.click()
        time.sleep(1)

        optionIntriggerFundOne = self.driver.find_element(By.XPATH, "//*[@id='liId_Secure Fund']")
        optionIntriggerFundOne.click()
        time.sleep(1)

        triggerPercentage = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[17]")
        triggerPercentage.click()
        time.sleep(1)
        # optionIntriggerPercentage = self.driver.find_element(By.XPATH, "//*[@id='liId_10%']")
        optionIntriggerPercentage = self.driver.find_element(By.XPATH, "//*[@id='liId_20%']")
        optionIntriggerPercentage.click()
        time.sleep(1)

        investorDropdownSelected= self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[19]")
        ...
        investmentDropdownSelected = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[20]")
        ...
        investmentDropdownUp = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[21]")
        ...
        habitDescription = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[22]")
        ...
        time.sleep(5)
        self.driver.switch_to.window(windowBefore)
    ...
    def newApplicationFormOneStepFive(self):
        ...
        time.sleep(1)
        chequeDateSelect = self.driver.find_element(By.XPATH, "//*[text()='7']")
