...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        self.wait.until(EC.element_to_be_clickable(
            (By.XPATH, "//*[@id='liId_Driving license issued abroad containing overseas address']")))
        proofSel = self.driver.find_element(By.XPATH,
                                            "//*[@id='liId_Driving license issued abroad containing overseas address']")
        proofSel.click()

        time.sleep(1)

        proofNumber = self.driver.find_element(By.XPATH, "//*[@name='proofNumber']")
        proofNumber.send_keys("12412343223")
        ...
        grossIncomeFill.send_keys('1600000')
        ...
        premiumCommitFill.send_keys("3200000")
        ...
        chooseFund = self.driver.find_element(By.XPATH, "//*[@for='dynamicFundYes']")
        chooseFund.click()

        systematicFund = self.driver.find_element(By.XPATH, "//*[@for='systematicNo']")
        systematicFund.click()

        investorDropdownSelected= self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[14]")
        ...
        investmentDropdownSelected = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[15]")
        ...
        investmentDropdownUp = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[16]")
        ...
        habitDescription = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[17]")
        ...
        yearNomineeSel.select_by_value('2005')
        ...
        guardianName= self.driver.find_element(By.XPATH, "//*[@name= 'nomineeGuardianName']")
        guardianName.send_keys("Guardian")
        print("Guardian entered")

        guardianrelationshipNominee = self.driver.find_element(By.XPATH, "(//*[@ tabindex='0'])[9]")
        guardianrelationshipNominee.click()
        time.sleep(1)

        valueinguardianrelationshipNominee = self.driver.find_element(By.XPATH, "//*[@id ='liId_Parent']")
        valueinguardianrelationshipNominee.click()
        time.sleep(1)
