...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        variantDropdown = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[11]")
        ...
        insurerAnnualIncomeFill.send_keys('1600000')
        ...
        hazardousActivitiesSelect = self.driver.find_element(By.XPATH, "(//*[contains(text(), 'No')])[2]")
        hazardousActivitiesSelect.click()

        criminalSelect = self.driver.find_element(By.XPATH, "(//*[contains(text(), 'No')])[3]")
        criminalSelect.click()

        travelSelect = self.driver.find_element(By.XPATH, "(//*[contains(text(), 'No')])[4]")
        travelSelect.click()
