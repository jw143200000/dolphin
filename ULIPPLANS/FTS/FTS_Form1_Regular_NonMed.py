...
class mProAutomate:
    ...
    def newApplicationFormOneStepOne(self):
        ...
        # panFill.send_keys("ACMPT9747D")
        panFill.send_keys("EDTPK8620N")
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        # firstNameFill.send_keys("TAPAS")
        firstNameFill.send_keys("NEETESH")


        lastNameFill = self.driver.find_element(By.XPATH,"//*[@name='lastName']")
        # lastNameFill.send_keys("TUNGA")
        ...
        # Cat 6 is below
        # grossIncomeFill.send_keys('3500000')
        ...
        productName.click()
        time.sleep(1)
        optionInProductName = self.driver.find_element(By.XPATH, "//*[@id='liId_Max Life Fast Track Super Plan']")
        ...
        time.sleep(1)
        optionInPremiumPaymentTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_20']")
        ...
        modePolicy = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[12]")
        modePolicy.click()
        time.sleep(1)
        modePolicyOption = self.driver.find_element(By.XPATH, "//*[@id='liId_Annual']")
        modePolicyOption.click()
        print("Annnual Selected")
        time.sleep(1)


        premiumCommitFill = self.driver.find_element(By.XPATH, "//*[@name='premiumCommitment']")
        # For Cat 5 is below
        # premiumCommitFill.send_keys("1600000")

        # For cat 6 is below
        # premiumCommitFill.send_keys("5000000")
        ...
        monthNomineeSel.select_by_value('10')
