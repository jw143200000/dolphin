...
class mProAutomate:
    ...
    # YBL  - 718842 | mnyl@4321 | Customer ID-  29471, 47942, 626018, 616658 (222222)
    # DST  - 934384 | MNYL@2020
    # SPARC- 782058 | MNYL@2020
    # Agency- 447660| Mnyl@2020 |max@1234- 615118, 358768, 340274, 642673, 784248, 511105, 512432, 548352, 440439
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        grossIncomeFill.send_keys('50000')
        ...
        recommendProductName = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[9]")
        ...
        policyTerm.click()
        time.sleep(2)
        optionPolicyTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_15']")
        ...
        # childYearDropdown = self.driver.find_element(By.XPATH, "//*[@class='react-datepicker__year-select']")
        # childYearSel = Select(childYearDropdown)
        # childYearSel.select_by_value('')
        ...
        time.sleep(1)
        optionInOrganisationSelect = self.driver.find_element(By.XPATH,
                                                              "//*[@id='liId_Non-Governmental Organization (NGO)']")
