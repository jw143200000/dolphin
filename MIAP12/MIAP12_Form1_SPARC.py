...
class mProAutomate:
    ...
    # SPARC- SPARC- 782058 | MNYL@2020, rpdel6793, ABBBY6754  | max@1234
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        firstNameFill.send_keys("Mohammad Jwala")
        ...
        cityFill.click()
        cityFill.send_keys('PANCHKULA')
        time.sleep(1)
        cityToSel= self.driver.find_element(By.XPATH, "//*[contains(text(),'PAN')]")
        cityToSel.click()
        time.sleep(1)
        print("City Filled")
        ...
        premiumCommitFill.send_keys("120000")
        ...
        fatherNameFill.send_keys("Raj Mohammad")

        motherNameFill = self.driver.find_element(By.XPATH, "//*[@name='motherName']")
        motherNameFill.send_keys("Kumari Lal")
        ...
        time.sleep(1)
        optionInEducationDropdown= self.driver.find_element(By.XPATH, "//*[contains(text(), 'Illiterate')][1]")
        ...
        organisationFill.send_keys("Julia Roberts")
        ...
        time.sleep(1)
        optionInRelationshipProposer= self.driver.find_element(By.XPATH, "//*[@id ='liId_Son']")
