...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        firstNameFill.send_keys("DHURBA")

        lastNameFill = self.driver.find_element(By.XPATH,"//*[@name='lastName']")
        lastNameFill.send_keys("CHHETRI")
        ...
        dateSel = self.driver.find_element(By.XPATH, "//*[@aria-label='day-26']")
        dateSel.click()
        time.sleep(2)
        ...
        landmarkFill = self.driver.find_element(By.XPATH, "//*[@name='permanentVillageTown']")
        landmarkFill.send_keys('Mumbai')

        villageFill = self.driver.find_element(By.XPATH, "//*[@name='permanentLandmark']")
        villageFill.send_keys('Mum')
        ...
        policyTerm.click()
        time.sleep(1)
        optionInPolicyTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_25']")
        ...
        desireIncome = self.driver.find_element(By.XPATH, "//*[@for='desiredAnnualIncomeYes']")
        desireIncome.click()
        time.sleep(1)

        grossIncomeFill = self.driver.find_element(By.XPATH, "//*[@name='annualIncome']")
        # grossIncomeFill.send_keys('1100000')
        grossIncomeFill.send_keys('500000')
        print("Gross Income Entered")
        ...
        # enterTermrider.send_keys("100000")
        # time.sleep(1)
        ...
        time.sleep(1)
        optionInEducationDropdown= self.driver.find_element(By.XPATH, "//*[contains(text(), 'High School')][1]")
        ...
        organisationNature = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[6]")
        organisationNature.click()
        time.sleep(1)
        optionInorganisationNature = self.driver.find_element(By.XPATH,
                                                              "//*[@id='liId_Non-combat role']")
        optionInorganisationNature.click()
        print("Organisation Selected")
        time.sleep(1)
        ...
        yearNomineeSel.select_by_value('1981')
        ...
        dateNomineeSel = self.driver.find_element(By.XPATH, "//*[@aria-label='day-15']")
        ...
        nameOfAccount.send_keys("Wonderful")
    ...
    def newApplicationFormOneStepFive(self):
        ...
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@for='ECS']")))
        radioCheque = self.driver.find_element(By.XPATH, "//*[@for='ECS']")
        radioCheque.click()
        print("ECS Selected.")
