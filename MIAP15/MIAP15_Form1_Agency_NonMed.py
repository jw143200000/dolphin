...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        enterADDrider.send_keys("100000")
        #
        ...
        organisationFill.send_keys("Corona")
        ...
        yearNomineeSel.select_by_value('1968')
        ...
        dateNomineeSel = self.driver.find_element(By.XPATH, "//*[@aria-label='day-11']")
