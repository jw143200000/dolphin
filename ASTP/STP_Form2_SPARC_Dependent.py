...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        firstNameFill.send_keys("Suman Kumar")
        ...
        lifeToInsured = self.driver.find_element(By.XPATH,
                                                 "//*[@name= 'insurerName']")
        lifeToInsured.send_keys("Jannat Singh Gujjar")
        time.sleep(1)
        ...
        optionInLifeStage= self.driver.find_element(By.XPATH, "//*[@id='liId_Single']")
        ...
        policyTerm.click()
        time.sleep(1)
        optionInPolicyTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_15']")
        ...
        fatherNameFill.send_keys("Roop Kumar Chanchal")

        motherNameFill = self.driver.find_element(By.XPATH, "//*[@name='motherName']")
        motherNameFill.send_keys("Chanchal Kumar Bharti")
        ...
        fatherNameFill.send_keys("Lalit K Chanchal")
        ...
        optionmaritalStatus = self.driver.find_element(By.XPATH, "//*[@id='liId_Single']")
        ...
        optionorgDropdown = self.driver.find_element(By.XPATH, "//*[@id='liId_Partner/Prop']")
