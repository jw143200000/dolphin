...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        firstNameFill.send_keys("Shankar Pratap")

        lastNameFill = self.driver.find_element(By.XPATH,"//*[@name='lastName']")
        lastNameFill.send_keys("YADAV")
        ...
        dateSel = self.driver.find_element(By.XPATH, "//*[@aria-label='day-28']")
        dateSel.click()
        time.sleep(2)

        houseNumberFill= self.driver.find_element(By.XPATH,"//*[@name='permanentHouseNo']")
        houseNumberFill.send_keys('RZG-511, Flat No.-21')

        roadNumberFill = self.driver.find_element(By.XPATH, "//*[@name='permanentRoadNo']")
        roadNumberFill.send_keys('Raj Najar- II')
        ...
        stateFill.send_keys('JHARKHAND')
        time.sleep(1)
        stateToSel=self.driver.find_element(By.XPATH, "//*[contains(text(),'JHARKHAND')]")
        stateToSel.click()
        time.sleep(1)
        print("State Filled")
        ...
        cityFill.click()
        cityFill.send_keys('DHANBAD')
        time.sleep(1)
        cityToSel= self.driver.find_element(By.XPATH, "//*[contains(text(),'DHANBAD')]")
        cityToSel.click()
        time.sleep(1)
        print("City Filled")

        pinToFill= self.driver.find_element(By.XPATH, "//*[@name='permanentPinCode']")
        pinToFill.send_keys('828203')
        time.sleep(1)
        ...
        addProofEnter = self.driver.find_element(By.XPATH,
                                                 "//*[@name= 'proofNumber']")
        addProofEnter.send_keys("VOT386346879")
        time.sleep(1)
        ...
        grossIncomeFill.send_keys('450000')
        ...
        veselSelect = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[6]")
        veselSelect.click()
        time.sleep(1)
        optionInveselSelect = self.driver.find_element(By.XPATH, "//*[@id='liId_Cargo Vessel']")
        optionInveselSelect.click()
        print("Organisation Selected")
        time.sleep(1)
        ...
        organisationFill.send_keys("First Nominee Name")
        ...
        yearNomineeSel.select_by_value('1973')
        ...
        monthNomineeSel.select_by_value('6')

        dateNomineeSel = self.driver.find_element(By.XPATH, "//*[@aria-label='day-27']")
    ...
    def newApplicationFormOneStepFour(self):
        ...
        time.sleep(1)
        selectHeightInInches = self.driver.find_element(By.XPATH, "//*[@id='liId_11']")
