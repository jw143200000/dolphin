...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        grossIncomeFill.send_keys('250000')
        ...
        time.sleep(1)
        optionInOrganisationSelect = self.driver.find_element(By.XPATH, "//*[@id='liId_Not Applicable']")
        ...
        organisationFill.send_keys("Jeevan Singh Chanchal")
