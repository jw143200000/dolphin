...
class mProAutomate:
    ...
    def newApplicationFormOneStepOne(self):
        ...
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@for='CIP']")))
        cipSelect = self.driver.find_element(By.XPATH,"//*[@for='CIP']")
        cipSelect.click()
        time.sleep(1)
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        firstNameFill.send_keys("UJJAWAL")
        ...
        grossIncomeFill.send_keys('142342134')
        ...
        optionInRecommendProduct = self.driver.find_element(By.XPATH, "//*[@id='liId_Max Life Cancer Insurance Plan']")
        optionInRecommendProduct.click()
        print("Product Selected")
        time.sleep(2)

        maturityAge = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[10]")
        maturityAge.click()
        time.sleep(1)
        optionInPremiumPaymentTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_60']")
        optionInPremiumPaymentTerm.click()
        print("Maturity  Selected")
        time.sleep(2)

        SumAssured = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[11]")
        SumAssured.click()
        time.sleep(1)
        optionInPolicyTerm = self.driver.find_element(By.XPATH, "//*[@id='liId_4000000']")
        ...
        preferredLanguage= self.driver.find_element(By.XPATH, "(//*[@ tabindex='0'])[4]")
        ...
        yearNomineeSel.select_by_value('2020')
        ...
        dateNomineeSel = self.driver.find_element(By.XPATH, "//*[@aria-label='day-28']")
        ...
        relationshipProposer = self.driver.find_element(By.XPATH, "(//*[@ tabindex='0'])[6]")
        ...
        guardianRelationship = self.driver.find_element(By.XPATH, "(//*[@ tabindex='0'])[7]")
        guardianRelationship.click()
        time.sleep(1)
        optionInguardianRelationship = self.driver.find_element(By.XPATH, "//*[@id ='liId_Parent']")
        optionInguardianRelationship.click()
        print("Relationship Wife Selected.")
        time.sleep(2)

        childName = self.driver.find_element(By.XPATH, "//*[@name='nomineeGuardianName']")
