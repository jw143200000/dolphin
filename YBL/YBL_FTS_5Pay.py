...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        # premiumTypeDropdown = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[8]")
        ...
        premiumPaymentTermValue = self.driver.find_element(By.XPATH, "//*[@id='liId_5']")
        premiumPaymentTermValue.click()
        print("5 Selected")

        policyTerm = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[9]")
        policyTerm.click()
        time.sleep(1)
        policyTermValue = self.driver.find_element(By.XPATH, "//*[@id='liId_10']")
        ...
        investorDropdownSelected = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[12]")
        ...
        investmentDropdownSelected = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[13]")
        ...
        investmentDropdownUp = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[14]")
        ...
        habitDescription = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[15]")
        habitDescription.click()
        print("Habit dropdown Clicked")
        time.sleep(1)

        optionDescription = self.driver.find_element(By.XPATH,
        ...
        popUp = self.driver.find_element(By.XPATH, "(//*[contains(text(),'Yes')])[4]")
        popUp.click()
