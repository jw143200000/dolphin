...
class mProAutomate:
    ...
    def newApplicationFormOneStepTwo(self):
        ...
        time.sleep(2)
        premiumType= self.driver.find_element(By.XPATH, "//*[@id='liId_Single Pay']")
        premiumType.click()
        ...
        fundOption = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[12]")
        fundOption.click()
        time.sleep(2)
        ...
        modeOfPayment.click()
        time.sleep(2)
        valueInmodeOfPayment = self.driver.find_element(By.XPATH, "//*[@id='liId_Single']")
        valueInmodeOfPayment.click()
        print("Policy Term Selected")
        time.sleep(1)
        ...
        annuityOption = self.driver.find_element(By.XPATH, "(//*[@tabindex='0'])[14]")
        annuityOption.click()
        time.sleep(1)
        ...
        singleLifeAnnuity = self.driver.find_element(By.XPATH,
                                                     "(//*[contains(text(),'Single Life Immediate Annuity for live')])[1]")
    ...
    def newApplicationFormOneStepThree(self):
        ...
        # nomineeDetails = self.driver.find_element(By.XPATH, "//*[@for='accountNumber101']")
        ...
        # bankDetails = self.driver.find_element(By.XPATH, "//*[@for='accountNumberforBank01']")
        # bankDetails.click()
        # print("Bank Selected.")
